...
function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
        ...
        <div className="max-w-6xl mx-auto p-4">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <h1 className="text-3xl font-bold text-gray-800">Zing</h1>
                <p className="text-gray-600">Suggests quick, witty, and energetic chats</p>
              </div>
            </div>
      ...
      <div className="max-w-6xl mx-auto pt-24" style={{ marginTop: '70px' }}>
        {/* Search Results */}
        {searchQuery && (
          <div className="mb-8" >
                ...
                >
                  <div className="p-6">
                    <div className="flex items-center mb-4">
                      <img
                        src={chat.isGroup ? 
                          (chat.picture || defaultGroup) : 
                          (chat.participants.find(p => p._id !== user?._id)?.profilePicture || defaultAvatar)
                        }
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl p-6 w-full max-w-md mx-4 shadow-2xl transform transition-all duration-300 scale-95 animate-scale-in">
            <div className="text-center">
              <div className="text-6xl mb-4">🎉</div>
              <h1 className="text-2xl font-bold mb-4 text-blue-600">Welcome to Zing!</h1>
