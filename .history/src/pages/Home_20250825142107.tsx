...
function Home() {
  ...
  return (
    <div className="flex h-full">
      ...
      {/* Main content area - Only show when a chat is selected */}
      {!showContactsList ? (
        ...
        // Empty div to prevent flex layout issues when only ContactsList is shown
        <div className="hidden md:flex-1 bg-gray-100"></div>
      )}
    </div>
  );
}
