...
function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4 z-index-100">
      {/* Header with Search */}
      <header className="max-w-6xl mx-auto mb-8 bg-white rounded-lg shadow-md p-4">
