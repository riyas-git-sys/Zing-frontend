...
function Profile() {
  ...
  const [theme, setTheme] = useState('light'); // New feature: theme preference
  const [notifications, setNotifications] = useState(true); // New feature: notification preferences
  const [lastSeen, setLastSeen] = useState(''); // New feature: last seen privacy
  const [activeTab, setActiveTab] = useState('profile'); // New feature: tab navigation
            ...
            <div className="md:w-1/3 bg-gradient-to-b from-blue-500 to-blue-700 p-6 text-white">
              ...
              <nav className="space-y-2">
                ...
                <button 
                  ...
                  className={`w-full text-left py-3 px-4 rounded-lg transition-all duration-200 ${activeTab === 'security' ? 'bg-white text-blue-700 font-medium' : 'hover:bg-blue-600'}`}
                >
                  Security
                </button>
              </nav>
