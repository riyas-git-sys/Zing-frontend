...
import { createGroupChat, searchUsers, getAllUsers, uploadGroupPicture } from '../services/chatService';
  ...
  const handleCreateGroup = async () => {
    ...
    try {
      ...
      if (groupPicture) {
        ...
        await uploadGroupPicture(data._id, formData);
      }
      ...
      <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="mb-4 flex flex-col items-center">
          <div className="relative w-20 h-20 mb-2">
            <img
              src={picturePreview || '/default-group.png'}
              alt="Group preview"
