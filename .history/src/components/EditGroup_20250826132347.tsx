// src/components/EditGroup.tsx
import { useState, useEffect } from 'react';
import { useParams, useNavigate } from 'react-router-dom';
import { useAuth } from '../context/AuthContext';
import { updateGroupInfo, uploadGroupPicture, getChats } from '../services/chatService';
...
function EditGroup() {
  ...
  useEffect(() => {
    const loadGroupInfo = async () => {
      try {
        // You might need to create a new service function to get a single chat
        // For now, let's reuse getChats
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white p-4 border-b sticky top-0 z-10">
        <div className="flex items-center">
          <button 
            onClick={() => navigate(`/group-info/${chatId}`)}
