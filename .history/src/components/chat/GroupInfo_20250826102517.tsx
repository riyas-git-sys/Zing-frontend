...
import { getChats, promoteToAdmin } from '../../services/chatService';
              ...
              <div className="space-y-2">
                {group.participants.map((participant: any) => (
                  <div key={participant._id} className="flex items-center justify-between">
                    ...
                    {isAdmin && participant._id !== user?._id && participant._id !== group.admin?._id && (
                      <button
                        onClick={() => setPromoteModal({ isOpen: true, user: participant })}
